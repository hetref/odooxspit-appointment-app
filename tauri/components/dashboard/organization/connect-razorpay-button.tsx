...
export function ConnectRazorpayButton({ className, isConnected = false }: ConnectRazorpayButtonProps) {
    ...
    const handleConnect = () => {
        try {
            ...
            const razorpayOAuthUrl = "https://auth.razorpay.com/authorize?response_type=code&client_id=RtwbhWkOCJIF1R&redirect_uri=https%3A%2F%2Fjeanene-unexposed-ingrid.ngrok-free.dev%2Fauth%2Frazorpay%2Fcallback&scope=read_write&state=current_state";
